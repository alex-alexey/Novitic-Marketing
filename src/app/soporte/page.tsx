    ...
    return (
      <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-10 max-w-md w-full text-center">
          ...
          <button
            onClick={() => { setTicketId(null); setForm({ email: "", nombre: "", titulo: "", descripcion: "", prioridad: "media" }); }}
    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-zinc-900">Soporte técnico</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                placeholder="Explica el problema con el mayor detalle posible: qué ocurre, cuándo empezó, pasos para reproducirlo..."
        ...
        <p className="text-center text-xs text-zinc-400 mt-6">
          Al enviar este formulario aceptas que procesemos tus datos para gestionar tu solicitud de soporte.
        </p>
      </div>
    </div>
  );
