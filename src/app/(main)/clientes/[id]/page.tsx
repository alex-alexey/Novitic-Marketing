...
import { ArrowLeft, Pencil, Clock, Ticket, AlertCircle, Loader2, Plus } from "lucide-react";
    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm px-6 py-5">
          ...
          <p className="text-3xl font-bold text-zinc-900">{totalHoras}h</p>
        </div>
        <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm px-6 py-5">
          <div className="flex items-center gap-2 text-zinc-500 text-sm mb-1">
            <AlertCircle size={15} />
      ...
      <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm">
        <div className="px-6 py-4 border-b border-zinc-100 flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-zinc-800">Tickets abiertos</h3>
            <p className="text-sm text-zinc-400 mt-0.5">{ticketsActivos.length} activo{ticketsActivos.length !== 1 ? "s" : ""}</p>
          </div>
        </div>
              ...
              <div key={t._id} className="flex items-center justify-between px-6 py-4 hover:bg-zinc-50 transition-colors">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-zinc-400 mt-1">
                    Abierta el {new Date(t.fechaApertura).toLocaleDateString("es-ES")}
                  </p>
                </div>
